...
public class ChatActivity extends AppCompatActivity{
    ...
    private void sendCloudMessage(ChatMessage m) {
        String serverKey = "AAAAnoaNNKY:APA91bEXQClTsHODQY64QqSEgpfMbzs9QoQFUGOxvS5skZgjzPenKRqQIf5IETQ2cq5lWF-pgQkSNGgHAD-0uPoonzgSajIqCSG4374PSQTHIsLjiM2JMWkZkM3b1w464bhSmOGLUp0B";
        String topic = "chat";
